...
{
    $("header").load("/Trilha-Front-end/js folder/jQuery/Coldigo Geladeiras/pages/CABEÇALHO.html")
    $("nav").load("/Trilha-Front-end/js folder/jQuery/Coldigo Geladeiras/pages/MENU.html")
    $("footer").load("/Trilha-Front-end/js folder/jQuery/Coldigo Geladeiras/pages/Rodape.html")
});